...
static void secp256k1_ecmult_gen(__generic secp256k1_gej *r, __generic secp256k1_scalar *gn) {
    secp256k1_ge add;
...
static void secp256k1_pubkey_save(__generic secp256k1_pubkey* pubkey, __generic secp256k1_ge* ge) {
...
int secp256k1_ec_pubkey_create(__generic secp256k1_pubkey *pubkey, const __generic unsigned char *seckey) {
    secp256k1_gej pj;
    secp256k1_ge p;
...
static int secp256k1_eckey_privkey_tweak_add(__generic secp256k1_scalar *key, const __generic secp256k1_scalar *tweak) {
    secp256k1_scalar_add(key, key, tweak);
    return !secp256k1_scalar_is_zero(key);
}

int secp256k1_ec_seckey_tweak_add(__generic unsigned char *seckey, const __generic unsigned char *tweak) {
...
static int secp256k1_pubkey_load(__generic secp256k1_ge* ge, const __generic secp256k1_pubkey* pubkey) {
  secp256k1_fe x, y;
...
static int secp256k1_eckey_pubkey_serialize(__generic secp256k1_ge *elem, __generic unsigned char *pub, __generic size_t *size, int compressed) {
...
int secp256k1_ec_pubkey_serialize(__generic unsigned char *output, size_t outputlen, const __generic secp256k1_pubkey* pubkey, uint flags) {
    secp256k1_ge Q;
    int ret = 0;
