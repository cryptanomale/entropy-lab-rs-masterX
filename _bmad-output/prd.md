...
inputDocuments:
  ...
  - "_bmad-output/analysis/research/technical-randstorm-coverage-gap-research-2025-12-22.md"
...
changelog:
  ...
  - date: '2025-12-22'
    changes: 'Coverage model update: Validated Phase 1 coverage at ~29% (was 60-70%) based on comprehensive gap analysis research. Updated all coverage estimates throughout document based on browser market share data, wallet-user correlation, and 8-gap validation study.'
---
...
- v2.1 (2025-12-22): Coverage model correction - Updated Phase 1 coverage from 60-70% to ~29% based on comprehensive gap analysis research validating browser market share, wallet-user correlation, and technical constraints
...
- ✅ **Coverage:** ~29% estimated vulnerable wallet coverage (25-33% range)
  - _Based on: Chrome 45-50% of web wallet users × 70% top 100 fingerprints × 87.5% P2PKH addresses × 65% ±24h timestamp window_
  - _Research Source: Comprehensive gap analysis (2025-12-22, 1604 lines, 8 gaps validated, 85% confidence)_
- ✅ **Performance:** ≥10x GPU speedup vs CPU baseline on RTX 3060 (or equivalent mid-range GPU)
- ✅ **Performance:** <30 seconds per address scan time (17.28M combinations: 100 fingerprints × 172,800 timestamps)
...
- ⏸️ **Coverage:** ~52% with Firefox SpiderMonkey LCG + Safari JavaScriptCore + BIP32 HD derivation
...
**Phase 3+ (Future):**
- ⏸️ **Coverage:** ~85-95% with IE Chakra MT19937 + mobile browsers + probabilistic search
- ⏸️ Extended timestamp windows (±7 days option)
- ⏸️ Mobile browser PRNGs (iOS Safari, Android Chrome)

**Coverage Model Validation:**
- Original estimate (PRD v1.0): 60-70% Phase 1 coverage
- Revised estimate (PRD v2.1): ~29% Phase 1 coverage (validated through 8-gap comprehensive research)
- Rationale: Original 60-70% referred to fingerprint coverage within Chrome users, not total vulnerable wallets across all browsers
- Browser reality: Chrome 45-50% of web wallet users (not 60-70% of total market)
- See: `_bmad-output/analysis/research/technical-randstorm-coverage-gap-research-2025-12-22.md` for complete validation
...
- ✅ **Coverage:** ~29% of vulnerable wallets (Chrome 45-50% web wallet users × 70% fingerprints × 87.5% P2PKH × 65% ±24h)
- ✅ **Address Support:** P2PKH (legacy Bitcoin addresses starting with '1') only - covers 85-90% of 2011-2015 wallets
- ✅ **Derivation:** Direct private key → P2PKH (no BIP32 HD wallet paths in Phase 1)
...
- ✅ **Output:** JSON/CSV with vulnerability results (address, fingerprint_id, timestamp_ms, confidence, coverage_note)
- ✅ **Progress Reporting:** Per-address progress bars with ETA and coverage estimate display
...
- ✅ **Documentation:** Usage guide, responsible disclosure framework, legal warnings, **29% coverage transparency**

**Coverage Expectation Management (Critical):**
- Phase 1 scans **Chrome V8 wallets only** (most common 2011-2015 browser among web wallet users)
- Estimated **~29% total coverage** of all vulnerable wallets (25-33% range, 85% research confidence)
- Missing: Firefox 11%, Safari 6%, IE 10-15%, Chrome BIP32 HD 4%, mobile 8-13%, others
- **Users must understand:** "Not found" ≠ "safe" - may be in Firefox/Safari/IE/mobile (Phase 2+)

**Out of Scope - Phase 1 (Deferred to Phase 2+):**
- ⏸️ **Other Browser PRNGs:** Firefox SpiderMonkey LCG (+11% coverage), Safari JavaScriptCore Xorshift128+ (+6%), IE Chakra MT19937 (+10-15%)
- ⏸️ **Expanded Fingerprints:** 500+ configurations (diminishing returns: only +2-4% for 5x more fingerprints)
- ⏸️ **Multi-Path Derivation:** BIP32/44/49/84/86 HD wallet paths (+4% coverage for 10-15% of 2011-2015 wallets)
- ⏸️ **Segwit Addresses:** P2SH-SegWit (prefix '3'), Native SegWit (prefix 'bc1') (minimal in 2011-2015, <1%)
...
- ⏸️ **Mobile Browsers:** iOS Safari mobile (+3-5%), Android Chrome mobile (+5-8%) - different PRNGs than desktop
- ⏸️ **Extended Timestamp Windows:** ±7 days option (adds +20-25% wallet capture but 3.5x slower)
...
## Revision Summary (v2.1 Changes - Coverage Model Update)

**Date:** 2025-12-22  
**Research Basis:** Comprehensive Gap Analysis (1,604 lines, 8 gaps investigated, 60+ sources, 85% confidence)

**Critical Coverage Model Correction:**
...
**Revised (v2.1) - Research-Validated:**
- **Phase 1: ~29% coverage** (25-33% range, Chrome V8 + top 100 fingerprints + P2PKH + ±24h)
- **Phase 2: ~52% coverage** (+ Firefox LCG + Safari Xorshift + BIP32 HD)
- **Phase 3: ~85-95% coverage** (+ IE Chakra + mobile browsers + probabilistic search)

**Root Cause of Discrepancy:**
- Original "60-70%" referred to **fingerprint coverage within Chrome users**, not total vulnerable wallets
- Research revealed Chrome = 45-50% of web wallet users (not 60-70% of all browser users)
- Browser market share (2011-2015): Chrome 38%, IE 28%, Firefox 19%, Safari 9%
- Phase 1 Chrome-only coverage: 45-50% wallet users × 70% fingerprints × 87.5% P2PKH × 65% ±24h = **~29%**

**8-Gap Validation Findings:**
1. ✅ Timestamp ±24h covers 65% of wallets (acceptable)
2. ✅ Chrome users over-represented among web wallet users (45-50% vs 38% general population)
3. ✅ PRNG version boundaries well-defined (Chrome 14-49, Firefox 7-42, Safari 5-8, IE 9-11)
4. ✅ P2PKH = 85-90% of 2011-2015 wallets (BIP32 HD adoption minimal until 2013-2014)
5. ✅ Mobile browsers = 8-13% additional coverage (iOS Safari, Android Chrome different PRNGs)
6. ✅ First open-source Randstorm scanner (strategic community advantage)
7. ✅ Model validated against Randstorm disclosure case studies
8. ✅ Top 100 fingerprints statistically optimal (70% coverage with minimal diminishing returns)

**Impact on PRD:**
- All coverage estimates updated throughout document
- Scope boundaries clarified with coverage percentages
- User expectation management emphasized (29% transparency critical)
- Phase 2 recommendations data-driven (prioritize Firefox + Safari over Chrome fingerprint expansion)
- Testing strategy unchanged (still validates 100% of synthetic test vectors)
